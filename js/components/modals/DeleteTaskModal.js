...
export class DeleteTaskModal extends BaseModal {
  ...
  getStatusBadge(status) {
    const map = {
      ...
      'review-qa': { label: 'Sedang Berjalan', color: 'bg-blue-50 text-blue-700 border-blue-200' },
      'ready-launch': { label: 'Sedang Berjalan', color: 'bg-blue-50 text-blue-700 border-blue-200' },
